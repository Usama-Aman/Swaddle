...
open class PayoutAccountPaymentBottomSheet : BottomSheetDialogFragment() {
    ...
    interface ClickListener {
        fun onCrossClicked(dialog: BottomSheetDialogFragment)
        fun onNextClicked(dialog: BottomSheetDialogFragment)
    }
}