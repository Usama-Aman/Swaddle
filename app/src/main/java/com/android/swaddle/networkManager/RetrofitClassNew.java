 ...
 */
public class RetrofitClassNew {

    private static RetrofitClassNew instance = null;
    private static WebRequestsKotlin service;

    private RetrofitClassNew() {
        // Exists only to defeat instantiation.
    }

    public static RetrofitClassNew getInstance() {
        if (instance == null) {
            instance = new RetrofitClassNew();
            ...
            service = retrofit.create(WebRequestsKotlin.class);
        }
        return instance;
    }

    public WebRequestsKotlin getWebRequestsInstance() {
